...
<li><a href="#">
            ...
            <li class="dropdown user-dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#"><i class="fa fa-user" style="color:#3bb9ff;"></i> Profile</a></li>
                <li><a href="#"><i class="fa fa-envelope"style="color:#3bb9ff;"></i> Inbox <span class="badge">7</span></a></li>
                <li><a href="#"><i class="fa fa-gear"style="color:#3bb9ff;"></i> Settings</a></li>
                <li class="divider"></li>
                <li><a href="#"><i class="fa fa-power-off"style="color:#ff0000;"></i> Log Out</a></li>
              </ul>
            </li>
            <li class="dropdown messages-dropdown" style="color:#fff;" >
