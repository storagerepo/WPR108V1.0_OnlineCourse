		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <img src="resources/images/authors/authors-icon.png" class="admin_student_image"/></td>
                        <td width="50%" align="left"><span class="admin_view_student_text1">Author Profile</span></td>
          ...
          <hr>
						<!-- <h2 ><img src="resources/images/global/course-icon.png" class="admin_student_image"/>Features Items</h2> -->
							<div class="col-sm-12">
<span class="AL_admin_createcourse_regformtable2td">Author  Details</span>
...
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author BIO</td>
<td width="67%" class="AL_admin_createcourse_regformtable1td">
...
<input type="submit" class="btn btn-default btn-lg btn-block" id="btnmine"value="Add New Author"/>
</td></tr>
</table>  <br/><br/>           
					</div><!--features_items-->
