		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <img src="resources/images/sites/custom-css.png" class="admin_student_image"/></td>
                        <td width="50%" align="left"><span class="admin_view_student_text1">Custom Css</span></td>
          ...
          <hr>
						<!-- <h2 ><img src="resources/images/global/course-icon.png" class="admin_student_image"/>Features Items</h2> -->
							<div class="col-sm-12">
<span class="AL_admin_createcourse_regformtable2td">Css Codes</span>
<span class="underline"></span>
<table  border="0" class="AL_admin_createcourse_regformtable1" style="border:none;">
<!-- 
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author Name</td>
...
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author Heading</td>
...
<textarea name="admin_AL_CC_coursename"  placeholder="..."class="AL_admin_createcourse_textarea2"/></textarea></td>
</tr>
<!-- <tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author facebook</td>
<td width="67%" class="AL_admin_createcourse_regformtable1td"><input type="text" name="admin_AL_CC_coursename" value="" placeholder="..."class="AL_admin_createcourse_textbx1"/></td>
</tr>
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author twitter</td>
<td width="67%" class="AL_admin_createcourse_regformtable1td"><input type="text" name="admin_AL_CC_coursename" value="" placeholder="..."class="AL_admin_createcourse_textbx1"/></td>
</tr>
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author Google+</td>
<td width="67%" class="AL_admin_createcourse_regformtable1td"><input type="text" name="admin_AL_CC_coursename" value="" placeholder="..."class="AL_admin_createcourse_textbx1"/></td>
</tr>

<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Author Qualification</td>
<td width="67%" class="AL_admin_createcourse_regformtable1td"><input type="text" name="admin_AL_CC_coursename" value="" placeholder="..."class="AL_admin_createcourse_textbx1"/></td>
</tr> -->
...
<!-- 
<table  border="0" class="AL_admin_createcourse_regformtable1" style="border:none">
<tr><td width="96%" class="AL_admin_createcourse_regformtable2td">Author Image</td>
</tr></table>
...
<td class="upload_instd"> <div class="upload_ins">Please click on the image to upload Your Author Profile image</div></td></tr></table></td>
</tr>
...
<input type="submit" class="btn btn-default btn-lg btn-block" id="btnmine"value="Add New Css"/>
</td></tr>
</table>  <br/><br/>           
					</div><!--features_items-->
