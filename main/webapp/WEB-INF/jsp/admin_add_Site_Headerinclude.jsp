		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <img src="resources/images/sites/header_includes.png" class="admin_student_image"/></td>
                        <td width="50%" align="left"><span class="admin_view_student_text1">Head Include</span></td>
...
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Include in Loggedin Users</td>
...
<tr><td width="29%" class="AL_admin_createcourse_regformtable1td">&nbsp;Include in Non-Loggedin <br>&nbsp; Users</td>
<td width="67%" class="AL_admin_createcourse_regformtable1td">
<textarea name="admin_AL_CC_coursename"  placeholder="..."class="AL_admin_createcourse_textarea1"/></textarea></td>
</tr>
