			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <img src="resources/images/sites/header.jpg" class="admin_student_image"/></td>
                        <td width="50%" align="left"><span class="admin_view_student_text1">&nbsp;Header List</span></td>
                        <td width="42.5%" align="right">
                       <a href="#" class="btn btn-default add-to-cart" id="top_button"><i class="fa fa-paste"></i>Add Header</a>
											</td></tr></table>
          <hr>
...
<th style="">Link URL</th>
<th style="">Actions</th></tr>
<tr><td width="17%" style="">New Author</td>
<td width="66%" style="">database</td>
