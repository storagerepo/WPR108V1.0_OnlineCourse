<div class="left-sidebar">
						...
						<div class="brands_products">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="#"> <span class="pull-right"><i class="fa fa-user"></i></span>User</a></li>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#sportswear">
											...
											<i class="fa fa-book"style=" font-size:21px;padding:0 15px 0 0;"></i>Courses
										</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#"><i class="fa fa-dollar"style=" font-size:21px;padding:0 15px 0 0;"></i> &nbsp;&nbsp;Financial</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
