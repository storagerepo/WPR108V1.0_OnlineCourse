		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <img src="resources/images/categories/categories.png" class="admin_student_image"/></td>
                        <td width="50%" align="left"><span class="admin_view_student_text1">&nbsp;Categories List</span></td>
          ...
          <hr>
						<!-- <h2 ><img src="resources/images/global/course-icon.png" class="admin_student_image"/>Features Items</h2> -->
							<div class="col-sm-12">
<span class="AL_admin_createcourse_regformtable2td">Categories  Info</span><br/>
...
<tr><td width="57%" style="">New Category</td>
<td width="26%" style=""><select name="" class="AL_admin_createcourse_selectbx1"><option value=" Visible"> Visible</option><option value="Hidden"> Hidden</option></select></td>
